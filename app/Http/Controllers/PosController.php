...
class PosController extends Controller
{
    ...
    public function add_pos_order(Request $request)
    {
        ...
        if ($not_available <= 0) {
            ...
            for ($i = 0; $i < count($product_id); $i++) {
                ...
                $pos_order_detail->customer_id = 1;
                ...
                if (!empty($pro_data)) {
                    ...
                    $product_qty_history_save->new_qty =-($item_quantity[$i]);
    ...
    //                 ->where('restore_status', 0)->limit(10)->get();
    ...
    //                     $restore_data .= '<tr onclick=get_order_items("' . $value->order_no . '")>
    ...
    //         $profit =  ($item_total - $offer_discount_amount - $discount_amount) - ($restoreReturnQtys[$i] * $pro_data->purchase_price);
