        ...
        $('.add_role').submit(function(e) {
            ...
            if (title === "") {
                show_notification('error',
                    '{{ trans('messages.add_role_name_lang', [], session('locale')) }}');
                return false;
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#all_role').DataTable().ajax.reload();
                    if (!id) $(".add_role")[0].reset();
                },
                error: function(data) {
                    hidePreloader();
                    after_submit();
