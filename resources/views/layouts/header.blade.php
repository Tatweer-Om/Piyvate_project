                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ url('images/avatar/1.jpg') }}" class="rounded-circle user_img" alt="nothing">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ url('images/avatar/2.jpg')}}" class="rounded-circle user_img"
                                                    alt="image">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ url('images/avatar/3.jpg')}}" class="rounded-circle user_img"
                                                    alt="image">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ url('images/avatar/4.jpg')}}" class="rounded-circle user_img"
                                                    alt="image">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ url('images/avatar/5.jpg')}}" class="rounded-circle user_img"
                                                    alt="image">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ url('images/avatar/1.jpg') }}" class="rounded-circle user_img">
                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="{{ url('images/avatar/1.jpg')}}" class="rounded-circle user_img_msg"
                                            alt="image">
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                        <img src="{{ url('images/avatar/2.jpg')}}" class="rounded-circle user_img_msg"
                                            alt="image">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link ai-icon" href="javascript:;" role="button"
                                    data-bs-toggle="dropdown">
                                    <svg class="svg-multi-color"width="25" height="25" viewBox="0 0 26 26"
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item ai-icon logout_button">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ url('pos') }}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-menu"></i>
                    ...
                    <li><a href="javascript:void(0);" class="ai-icon has-arrow" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ url('branch') }}">Bracnhs</a></li>
