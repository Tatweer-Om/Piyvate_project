                                ...
                                <div class="row text-center small">
                                    <div class="col-4">
                                        <div class="bg-warning bg-opacity-10 rounded-3 p-2">
                                            ...
                                            <div class="text-warning">Appointments</div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="bg-success bg-opacity-10 rounded-3 p-2">
                                            ...
                                            <div class="text-success">Sessions</div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="bg-danger bg-opacity-10 rounded-3 p-2">
                                            <i class="bi bi-geo-alt-fill text-danger fs-5"></i>
                                            <div class="fw-bold text-danger">USA</div>
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="card shadow-sm rounded-3">
                            <div class="card-body p-3 text-center">
                                <h6 class="text-primary mb-3"><i class="bi bi-ui-checks-grid me-2"></i> Actions</h6>
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary btn-sm rounded-pill">View History</button>
                                    <button class="btn btn-success btn-sm rounded-pill">New Prescription</button>
                                    <button class="btn btn-warning btn-sm rounded-pill">Lab Reports</button>
                                    <button class="btn btn-danger btn-sm rounded-pill">Critical Alerts</button>
                                    <button class="btn btn-info btn-sm rounded-pill">Schedule</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm rounded-4 border-0">
                            <div class="card-body">
                                <ul class="nav nav-tabs mb-3">
                                    ...
                                    <li class="nav-item">
                                        <a href="#payment_history" data-bs-toggle="tab" class="nav-link">
