...
<div class="receipt border rounded">
  <div class="row mb-4 align-items-center">
    ...
    <div class="col-md-8 text-end">
      ...
      <p class="mb-0">Appointment Date: <strong>{{ $appointment->appointment_date ?? '' }}</strong></p>
      <p class="mb-0">Appointment No: <strong>{{ $appointment->appointment_no ?? '' }}</strong></p>
    </div>
  </div>
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td>
            {{ date('g:i A', strtotime($appointment->time_from)) }} -
            {{ date('g:i A', strtotime($appointment->time_to)) }}
        </td>
