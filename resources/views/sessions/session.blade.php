                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table id="all_session" class="table table-striped patient-list mb-4 dataTablesCard fs-14">
                                <thead>
                                    <tr>
                                        <th>Sr No</th>
                                        <th>session Name</th>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">session Model</h5>
          ...
          <div class="modal-body">
            <form class="add_session">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input session_type" type="radio" name="session_type" id="ministry" value="ministry" required>
                                    <label class="form-check-label" for="ministry">Ministries</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input session_type" type="radio" name="session_type" id="normal" value="normal" required>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12" id="govt_select_div" style="display: none;">
                        <div class="form-group">
                            <label class="col-form-label">Select Government</label>
                            <select class="form-control government" name="government">
