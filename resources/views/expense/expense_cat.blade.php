...
@section('main')
    @push('title')
        <title> {{ trans('messages.Expense Categorys_lang', [], session('locale')) }}</title>
    @endpush
    <style>
    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0)">Expense Category</a></li>
            </ol>
        </div>
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start flex-wrap">
            <div class="me-auto mb-3 mb-md-0">
                <a href="javascript:void();" class="btn btn-primary btn-rounded add-staff" data-bs-toggle="modal" data-bs-target="#add_expense_category_modal">+ Add Expense Category</a>
            </div>
        ...
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Expense Category Model</h5>
                ...
                <div class="row">
                  <div class="col-lg-12 col-xl-12">
                    <div class="form-group">
                      <label class="col-form-label">Expense Category Name</label>
                      <input type="text" class="form-control expense_category_name" id="name1" name="expense_category_name" placeholder="Expense Category Name">
                    </div>
                  </div>
